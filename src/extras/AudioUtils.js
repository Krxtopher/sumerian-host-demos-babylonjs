/**
 * A collection of useful audio functions.
 */
 ...
 */
export function downsampleAudio(buffer, sourceSampleRate, targetSampleRate) {
 ...
 */
export function encodeWAV(buffer, targetSampleRate) {
